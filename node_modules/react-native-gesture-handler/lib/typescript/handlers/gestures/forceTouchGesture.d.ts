import { BaseGestureConfig, ContinousBaseGesture } from 'react-native-gesture-handler/src/handlers/gestures/gesture';
import { ForceTouchGestureConfig } from 'react-native-gesture-handler/src/handlers/ForceTouchGestureHandler';
import type { ForceTouchGestureHandlerEventPayload } from 'react-native-gesture-handler/src/handlers/GestureHandlerEventPayload';
import { GestureUpdateEvent } from 'react-native-gesture-handler/src/handlers/gestureHandlerCommon';
/**
